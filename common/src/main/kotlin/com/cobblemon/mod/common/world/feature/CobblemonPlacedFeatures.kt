...
object CobblemonPlacedFeatures {
    ...
    fun register() {
        ...
        Cobblemon.implementation.addFeatureToWorldGen(ROCKY_TIDEPOOLS, GenerationStep.Decoration.LOCAL_MODIFICATIONS, CobblemonBiomeTags.IS_STONY_SHORE)
        ...
        Cobblemon.implementation.addFeatureToWorldGen(SKELETAL_FALL, GenerationStep.Decoration.LOCAL_MODIFICATIONS, CobblemonBiomeTags.IS_SOUL_FIRE)
        ...
        Cobblemon.implementation.addFeatureToWorldGen(PREHISTORIC_SUBMERGED_SPIKE, GenerationStep.Decoration.LAKES, CobblemonBiomeTags.IS_FROZEN_OCEAN)
