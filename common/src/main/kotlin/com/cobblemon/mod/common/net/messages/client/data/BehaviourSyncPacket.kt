...
class BehaviourSyncPacket(entries: Map<Identifier, CobblemonBehaviour>) : DataRegistrySyncPacket<Map.Entry<Identifier, CobblemonBehaviour>, BehaviourSyncPacket>(entries.entries.toList()) {
    companion object {
    ...
    override val id = ID
    override fun decodeEntry(buffer: RegistryFriendlyByteBuf): Map.Entry<Identifier, CobblemonBehaviour>? {
        ...
        return object : Map.Entry<Identifier, CobblemonBehaviour> {
            override val key = identifier
            override val value = behaviour
        }
    }

    override fun encodeEntry(buffer: RegistryFriendlyByteBuf, entry: Map.Entry<Identifier, CobblemonBehaviour>) {
    ...
    override fun synchronizeDecoded(entries: Collection<Map.Entry<Identifier, CobblemonBehaviour>>) {
