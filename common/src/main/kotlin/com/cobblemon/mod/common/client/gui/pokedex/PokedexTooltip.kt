...
fun setTooltipForNextFrame(context: GuiGraphicsExtractor, text: MutableComponent, posX: Int, posY: Int, delta: Float, offsetY: Int = 0) {
    ...
    // PT143: mainRenderTarget.bindWrite removed in MC 26.1.x; processBlurEffect signature dropped delta param.
    // Defer to JEI default rendering until render pipeline can be re-wired.
    Minecraft.getInstance().let {
        ...
        it.gameRenderer.processBlurEffect()
