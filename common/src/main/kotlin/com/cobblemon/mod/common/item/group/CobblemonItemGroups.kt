...
object CobblemonItemGroups {
    ...
    private fun blockEntries(displayContext: ItemDisplayParameters, entries: Output) {
        ...
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_NORMAL)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_FIRE)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_WATER)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_ELECTRIC)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_GRASS)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_ICE)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_FIGHTING)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_POISON)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_GROUND)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_FLYING)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_PSYCHIC)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_BUG)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_ROCK)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_GHOST)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_DRAGON)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_DARK)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_STEEL)
        entries.accept(CobblemonItems.TYPE_GEM_CLUSTER_FAIRY)
